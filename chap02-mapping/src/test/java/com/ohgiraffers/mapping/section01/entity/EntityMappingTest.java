...
public class EntityMappingTest {
    ...
    *   4. 연관관계 매핑(@ManyToOne , @OneToMany , @OneToOne , @JoinColumn 등등)
    * */
    ...
    void testCreateTable(int memberNo, String memberId, String memberPwd , String memberName , String phone , String address , LocalDateTime enrollDate
    , MemberRole memberRole , String status){

        MemberRistDTO newMember = new MemberRistDTO(
                memberId,memberPwd,memberName,phone,address,enrollDate,memberRole,status
        );

        //메소드 검증시 사용하는 메소드, 해당 메소드가
